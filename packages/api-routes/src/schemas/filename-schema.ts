...
const filenameSchema = z
  .string()
  .min(1, {
    message: "Filename is required and must be at least one character long.",
  })
  .max(64, {
...
export const createFilenameWithExtensionSchema = (
  allowedExtensions: Set<string | undefined>,
) => {
